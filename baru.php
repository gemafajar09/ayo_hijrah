          ...
          <div class="col-xl-12 col-lg-12 order-lg-2">
            ...
            <div class="isotope-grid cols-4 mb-2">
			  ...
			  <?php
					...
					$jml_data = mysqli_query($con, "SELECT * FROM tbl_produk where stok > 0 AND jenis='Baru'");
				...
				if (isset($_POST["cari2"])){
					$cari =$_POST['cari'];
						$q =$_POST['q'];
					$sql = mysqli_query($con, "SELECT * FROM tbl_produk,tbl_merek where tbl_produk.id_merek=tbl_merek.id_merek AND tbl_merek.id_merek like '%$cari%' and tbl_produk.judul like '%$q%' and tbl_produk.stok > 0 AND jenis='Baru' LIMIT $posisi, $batas");
				} else{
				$sql = mysqli_query($con, "SELECT * FROM tbl_produk where jenis='Baru' AND stok > 0  LIMIT $posisi, $batas");
				}
              ...
              <div class="column">
                <ul class="pagination">
								<?php
								  ...
								  <li class="page-item">
									<a class="page-link" href="shop-1<?php echo $i; ?>"><?php echo $i; ?></a>
								  </li>
								  <?php } ?>
								  <?php
								  if ($pg < $pages){ ?>
