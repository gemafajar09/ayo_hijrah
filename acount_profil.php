...
<div class="offcanvas-wrapper">
  ...
  if (isset($_POST["update"])) {
    ...
    if (!empty($_POST["password"])) {
      mysqli_query($con, "UPDATE tb_customer set nama_lengkap='$_POST[nama_lengkap]', nohp='$_POST[nohp]', password='$pass' where id_customer='$_SESSION[idcs]'");
      echo "<script>window.location='?module=acount_profil';</script>";
    } else if (empty($_POST["password"])) {
      mysqli_query($con, "UPDATE tb_customer set nama_lengkap='$_POST[nama_lengkap]', nohp='$_POST[nohp]' where id_customer='$_SESSION[idcs]'");
