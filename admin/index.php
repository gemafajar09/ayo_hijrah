    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="index.php" class="dropdown-toggle" data-toggle="dropdown">
                  <?php
                  if ($foto == "") { ?>
                    <img style="border:1px solid #eaeaea;border-radius:50px;" src="images/user/profiledummy.png" class="user-image" alt="User Image">
                  <?php
                  } else { ?>
                    <img style="border:1px solid #eaeaea;border-radius:50px;" src="images/user/<?php echo $foto; ?>" class="user-image" alt="User Image">
                  <?php
                  }
                  ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <img style="border:1px solid #eaeaea;border-radius:50px;" src="images/user/profiledummy.png" class="img-circle">
                    <p>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            ?>
              ...
              <li><a href="?page=bank"><i class="fa fa-credit-card"></i>Informasi Bank</a></li>
      ...
      <div class="content-wrapper">
        ...
        if ($_GET['page'] == "" || $_GET['page'] == "home") {
          ...
          include "CRUD/modul_rekening/bank.php";
