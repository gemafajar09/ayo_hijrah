...
<body>
    <div class="container">
        ...
        <br>
        <h3 align="center"><u>Laporan Data Penjualan Tahun <?php echo $tahun  ?></u></h3>
        <br>
        <div class="row">
            <div>
                <div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            $total = 0;
                            $tahun = $_POST['tahun'];
                            $ambil = $conn->query("SELECT * FROM tb_transaksi WHERE status_order = 'Proses Pengiriman' AND tgl_order LIKE '$tahun%' ");
