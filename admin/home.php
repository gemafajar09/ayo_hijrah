...
<section class="content">
  <div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <?php 
			$sql=mysqli_query($con, "SELECT COUNT(id_customer) AS jmlh_customer FROM tbl_customer ");
			$r= mysqli_fetch_assoc($sql);
		  ?>
...
<div class="pull-left info">
  <marquee behavior="" direction=""><h2 style="font-family: fantasy; font-size: 50px">&nbsp;&nbsp;&nbsp;Selamat Datang Karyawan <?php echo $_SESSION['namaadmn']; ?></h2></marquee>
  <table align="center">
    <tr>
      <td width="200px"> &nbsp;</td>
