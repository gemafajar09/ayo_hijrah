...
if (isset($_POST['lanjutkan'])) {
  $alamat = $_POST['alamat'];
  mysqli_query($con, "UPDATE tb_customer SET alamat_aktif='$alamat'");
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-lg-12">
        ...
        <div class="row padding-top-1x mt-3">
          <div class="col-sm-6">
            <?php
            $sql = mysqli_query($con, "SELECT * FROM tbl_alamat,tb_customer where tbl_alamat.id_customer=tb_customer.id_customer AND
